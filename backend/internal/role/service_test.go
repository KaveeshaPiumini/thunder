...
func (suite *RoleServiceTestSuite) TestUpdateRole_GetRoleError() {
	...
	suite.mockStore.On("IsRoleExist", mock.Anything, "role1").Return(0, errors.New("database error"))
...
func (suite *RoleServiceTestSuite) TestUpdateRole_OUNotFound() {
	...
	suite.mockResourceService.On("ValidatePermissions", mock.Anything, "rs1", []string{"perm1"}).Return([]string{}, nil)
	suite.mockStore.On("IsRoleExist", mock.Anything, "role1").Return(1, nil)
...
func (suite *RoleServiceTestSuite) TestUpdateRole_RoleNotFound() {
	...
	suite.mockResourceService.On("ValidatePermissions", mock.Anything, "rs1", []string{"perm1"}).Return([]string{}, nil)
	suite.mockStore.On("IsRoleExist", mock.Anything, "nonexistent").Return(0, nil)
...
func (suite *RoleServiceTestSuite) TestUpdateRole_PermissionValidationErrors() {
	testCases := []struct {
		...
		},
		{
			...
			setupMocks: func() {
				ou := oupkg.OrganizationUnit{ID: "ou1"}
				suite.mockStore.On("IsRoleExist", mock.Anything, "role1").Return(1, nil).Once()
